...
public class RegistroKmServiceTest {
    ...
    @InjectMocks
    private RegistroKmService registroKmService;
    ...
    void naoDeveCadastrarRegistroKmQuandoNaoExistirMotoboy() {
        ...
        assertThrows(RegraDeNegocioException.class, () -> registroKmService.cadastrarKmDiario(dados));
    }
    ...
    void naoDeveCadastrarRegistroKmQuandoUltimoKmEstiverEmAberto() {
        ...
        var erro = assertThrows(RegraDeNegocioException.class, () -> registroKmService.cadastrarKmDiario(dados));
    ...
    void DeveCadastrarQuandoNaoExisteUltimoKm() {
        ...
        var resultado = registroKmService.cadastrarKmDiario(dados);
